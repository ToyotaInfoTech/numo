...
Thank you for your interest in contributing to NUMo ("We" or "Us").
...
We agree to (sub)license the Contribution or any Materials containing, based on or derived from your Contribution under the terms of the following licenses: Open Data Commons Open Database License (ODbL) v1.0 for the SUMO network file; CC-BY-4.0 for all other files.

We agree to license patents owned or controlled by You only to the extent necessary to (sub)license Your Contribution(s) and the combination of Your Contribution(s) with the Material under the terms of the following licenses: Open Data Commons Open Database License (ODbL) v1.0 for the SUMO network file; CC-BY-4.0 for all other files.
